    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-emerald-500/30">
        ...
        <div className="fixed top-0 left-0 right-0 z-[60] bg-[#0f1523] border-b border-slate-800 px-3 py-2 flex items-center justify-between shadow-md">
          <div className="flex items-center gap-3">
            ...
            <div className="w-10 h-10 rounded-xl overflow-hidden shrink-0 border border-slate-700">
              <img src="/logo.png" alt="Tech Habesha" className="w-full h-full object-cover" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <img src="/logo.png" alt="Tech Habesha Logo" className="w-10 h-10 rounded-full object-cover border border-slate-800" />
      ...
      <footer className="bg-slate-950 border-t border-slate-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <img src="/logo.png" alt="Tech Habesha Logo" className="w-8 h-8 rounded-full object-cover border border-slate-800" />
          ...
          >
            ...
            <div className="p-8 overflow-y-auto w-full text-slate-300 leading-relaxed text-sm">
              <div className="flex justify-center mb-6">
                <img src="/logo.png" alt="Tech Habesha Logo" className="w-24 h-24 rounded-full object-cover border-4 border-emerald-500/20 shadow-lg" />
              </div>
